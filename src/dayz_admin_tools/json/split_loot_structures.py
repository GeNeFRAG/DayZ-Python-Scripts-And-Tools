...
class SplitLootStructures(XMLJSONTool):
    """
    Split DayZ JSON objects into loot and structures based on types.xml.
    ...
    def split_objects(self, types_xml: str, input_json: str,
        ...
        for obj in data["Objects"]:
            if "name" not in obj:
                logger.warning("Object without 'name' found, skipping")
                continue
...
def main():
    ...
    parser.add_argument("--loot-json", default=None,
                        help="Output JSON file for loot objects. If not specified, "
                             "a default path in the standard output directory will be used.")
    parser.add_argument("--structures-json", default=None,
                        help="Output JSON file for structure objects. If not specified, "
                             "a default path in the standard output directory will be used.")
