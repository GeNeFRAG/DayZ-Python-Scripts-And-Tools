...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='Configure DayZ Deathmatch server by filtering buildings and customizing loot spawns.\n'
        'Features:\n'
    ...
    parser.add_argument('--pos-output', '-f',
                        help='Filename for the filtered buildings output file '
                             '(defaults to deathmatch_<original filename> with timestamp)')
    ...
    parser.add_argument('--proto_output', '-o',
                        help='Filename for the final output proto file '
                             '(defaults to deathmatch_<original filename> with timestamp)')
