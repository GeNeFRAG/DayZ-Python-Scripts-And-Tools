...
def main():
    ...
    parser.add_argument('--events',
                        help='Path to the events.xml file (uses paths.events_file from config if not '
                             'specified)',
                        dest='events_xml'
                        )
    parser.add_argument('--groups',
                        help='Path to the cfgeventgroups.xml file (uses paths.eventgroups_file from config '
                             'if not specified)',
                        dest='groups_xml'
                        )
    parser.add_argument('--output',
                        help='Path to the output CSV file (defaults to pattern-specific filename in standard '
                             'output directory)',
                        dest='output_csv'
                        )
    parser.add_argument('--type',
                        help='Type of mildrop to analyze: "standard" for StaticMildrop/Mildrop, "special" for '
                             'StaticMildropSpecial/MildropSpecial, or "both" to analyze both types (default: '
                             'standard)',
                        dest='mildrop_type',
