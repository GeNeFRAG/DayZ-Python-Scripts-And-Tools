...
def extract_values(xml_file):
    ...
    for type_elem in root.findall("type"):
        ...
        quantmin = type_elem.find("quantmin")
        quantmax = type_elem.find("quantmax")
        values[name] = {
            ...
            "quantmin": int(quantmin.text) if lifetime is not None else None,
            "quantmax": int(quantmax.text) if lifetime is not None else None,
        }
    return values
            ...
            differences.append(
                {
                    ...
                    "file1_quantmin": file1_vals.get("quantmin"),
                    "file1_quantmax": file1_vals.get("quantmax"),
                    ...
                    "file2_quantmin": file2_vals.get("quantmin"),
                    "file2_quantmax": file2_vals.get("quantmax"),
                    "nominal_diff": (
                        (file1_vals.get("nominal") - file2_vals.get("nominal"))
                        if file1_vals.get("nominal") is not None
                        and file2_vals.get("nominal") is not None
                        else None
                    ),
                    "lifetime_diff": (
                        (file1_vals.get("lifetime") - file2_vals.get("lifetime"))
                        if file1_vals.get("lifetime") is not None
                        and file2_vals.get("lifetime") is not None
                        else None
                    ),
                    "restock_diff": (
                        (file1_vals.get("restock") - file2_vals.get("restock"))
                        if file1_vals.get("restock") is not None
                        and file2_vals.get("restock") is not None
                        else None
                    ),
                    "min_diff": (
                        (file1_vals.get("min") - file2_vals.get("min"))
                        if file1_vals.get("min") is not None
                        and file2_vals.get("min") is not None
                        else None
                    ),
                    "quantmin_diff": (
                        (file1_vals.get("quantmin") - file2_vals.get("quantmin"))
                        if file1_vals.get("quantmin") is not None
                        and file2_vals.get("quantmin") is not None
                        else None
                    ),
                    "quantmax_diff": (
                        (file1_vals.get("quantmax") - file2_vals.get("quantmax"))
                        if file1_vals.get("quantmax") is not None
                        and file2_vals.get("quantmax") is not None
                        else None
                    ),
                }
            )
